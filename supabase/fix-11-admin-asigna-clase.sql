-- Fix 11: el admin puede asignar directamente un cupo disponible a un
-- alumno (sin que el alumno tenga que reservarlo el mismo desde la app).
-- Respeta las mismas reglas que una reserva normal: cupo libre y que el
-- alumno no se haya pasado del limite de clases de su paquete.
